...
const getEmail = () => `${EMAIL_PARTS.user}@${EMAIL_PARTS.domain}.${EMAIL_PARTS.tld}`;
...
export default function Contact() {
  ...
  const regularContactMethods = [
    {
      icon: <LinkedIn sx={{ fontSize: 48 }} />,
      label: 'LinkedIn',
      value: '25,000+ Followers',
          ...
          <GridItem xs={12} sm={4}>
            <Card
              ...
              sx={{
                ...
                borderTop: `3px solid ${GOOGLE_COLORS.red}`,
                '&:hover': {
                  transform: 'translateY(-8px)',
                  boxShadow: `0 20px 25px -5px ${GOOGLE_COLORS.red}30, 0 10px 10px -5px ${GOOGLE_COLORS.red}20`,
                },
              }}
            >
              <CardContent sx={{ py: 4 }}>
                <Box sx={{ color: GOOGLE_COLORS.red, mb: 2 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  {emailRevealed && email ? email : 'Click to reveal'}
                </Typography>
              </CardContent>
            </Card>
          </GridItem>
